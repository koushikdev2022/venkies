                        ...
                        <div class="row">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select" name="user_id" type="text" >
                                        ...
                                        @forelse($users as $key=>$user)
                                            <option value="{{$user->id}}" @if($leaves->user_id== $user->id) selected @endif>{{$user->name}}</option>
                                        @empty
                                        @endforelse
                                    </select>
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <select name="type" id="type" class="form-select">
                                        <option value="{{$leaves->type}}">{{$leaves->type}}</option>
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" name="cause" value="{{$leaves->cause}}" id="cause" placeholder="Cause of Leave">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input class="form-control" name="from" type="date" value="{{$leaves->from}}" id="from" placeholder="From">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="mb-4">
