        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="card-title-desc">update Cart</p>
                </div>
                <div class="card-body">
                    <form action="{{ route( 'cart.update',$carts->id) }}" method="post" enctype="multipart/form-data">@csrf
                        <div class="row">
                            {{--                            <div class="col-sm-6">--}}
                            {{--                                <div class="mb-4">--}}
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select" name="retailer" type="text" >
                                        ...
                                        @forelse($retailers as $key=>$retailer)
                                            <option value="{{$retailer->id}}"  @if($carts->id== $retailer->id) selected @endif>{{$retailer->name}}</option>
                                        @empty
                                        @endforelse
                                    </select>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select" name="product" type="text" >
                                        ...
                                        @forelse($products as $key=>$product)
                                            <option value="{{$product->id}}"  @if($carts->id== $product->id) selected @endif>{{$product->name}}</option>
                                        @empty
                                        @endforelse
                                    </select>
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input class="form-control @error('quantity') is-invalid @enderror" name="quantity" type="number" value="{{$carts->quantity}}" id="quantity" placeholder="Enter number  ..">
                                    @error('quantity')
                            ...
                            <div class="col-sm-6">
                                <div>
                                    ...
                                    <input class="form-control @error('price') is-invalid @enderror " name="price" value="{{$carts->price}}" type="text" id="price" placeholder="price">
                                    @error('price')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
