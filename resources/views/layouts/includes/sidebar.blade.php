    ...
    <div data-simplebar="init" class="h-100 mm-show"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: -16.8px; bottom: 0px;"><div class="simplebar-content-wrapper" style="height: 100%; overflow: hidden scroll;"><div class="simplebar-content" style="padding: 0px;">
                            ...
                            <div id="sidebar-menu" class="mm-active">
                                ...
                                <ul class="metismenu list-unstyled mm-show" id="side-menu">
                                    <li class="menu-title" data-key="t-menu">Menu
                                    </li>
                                    <li class="mm-active">
                                        <a href="{{route('dashboard.index')}}" class="active">
                                            ...
                                            <li>
                                                <a href="javascript: void(0);" class="has-arrow">
                                                    <span data-key="t-contacts">InDemandProduts</span>
                                                </a>
                                                <ul class="sub-menu mm-collapse" aria-expanded="false">
                                                    <li><a href="{{route('indemand.index')}}" data-key="t-user-grid"> List</a></li>
                                                    <li><a href="{{route('indemand.create')}}" data-key="t-user-list"> Create</a></li>
                                                </ul>
                                            </li>
                                            <li>
                                                <a href="javascript: void(0);" class="has-arrow">
                                                    <span data-key="t-contacts">Attendance</span>
                                                </a>
                                                <ul class="sub-menu mm-collapse" aria-expanded="false">
                                                    <li><a href="{{route('attendance.index')}}" data-key="t-user-grid"> List</a></li>
                                                    <li><a href="{{route('attendance.create')}}" data-key="t-user-list"> Create</a></li>
                                                </ul>
                                            </li>
                                            <li>
                                                <a href="javascript: void(0);" class="has-arrow">
                                                ...
                                                <ul class="sub-menu mm-collapse" aria-expanded="false">
                                                    <li><a href="{{route('meeting.index')}}" data-key="t-user-grid"> List</a></li>
                                                    <li><a href="{{route('meeting.create')}}" data-key="t-user-list"> Create</a></li>
                                                </ul>
                                            </li>
                                            <li>
                                                <a href="javascript: void(0);" class="has-arrow">
...
{{--                                                    <li><a href="{{route('retailer.create')}}" data-key="t-user-list"> Create</a></li>--}}
                                             ...
                                             <li>
                                        <a href="javascript: void(0);" class="has-arrow">
                                            <span data-key="t-contacts">Location</span>
                                        </a>
                                        <ul class="sub-menu mm-collapse" aria-expanded="false">
                                            <li><a href="{{route('location.index')}}" data-key="t-user-grid"> List</a></li>
                                            <li><a href="{{route('location.create')}}" data-key="t-user-list"> Create</a></li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="javascript: void(0);" class="has-arrow">
                                            <span data-key="t-contacts">Cart</span>
                                        </a>
                                        <ul class="sub-menu mm-collapse" aria-expanded="false">
                                            <li><a href="{{route('cart.index')}}" data-key="t-user-grid"> List</a></li>
                                            <li><a href="{{route('cart.create')}}" data-key="t-user-list"> Create</a></li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="javascript: void(0);" class="has-arrow">
                                            <span data-key="t-contacts">Leave</span>
                                        </a>
                                        <ul class="sub-menu mm-collapse" aria-expanded="false">
                                            <li><a href="{{route('leave.index')}}" data-key="t-user-grid"> List</a></li>
                                            <li><a href="{{route('leave.create')}}" data-key="t-user-list"> Create</a></li>
                                        </ul>
                                    </li>
